...
#df = pd.read_csv("._HIST_PAINEL_COVIDBR_13mai2021.csv", sep=";", encoding="utf-8")
...
# =========================================
# Instanciação do código do Dash
...
fig = px.choropleth_mapbox(df_states_, locations="estado", color="casosNovos", 
                           ...
                           hover_data=["casosAcumulado", "casosNovos", "obitosNovos", "estado"],
                           center={"lat": -16.95, "lon": -47.78}, zoom=4)

# detalhes de estilo do mapbox
fig.update_layout(
...
app.layout = dbc.Container(
    ...
    dbc.Row([
        dbc.Col([
            html.Div([
                html.H4("COVID-19 Data Analysis Dashboard"),
...
@app.callback([Output("casos-recuperados-text", "children"),
...
@app.callback(Output("location-button", "children"), 
